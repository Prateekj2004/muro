...
// // Custom Link Component with TypeScript
// const ScrollLink: React.FC<LinkProps> = ({ to, className, children, style, ...props }) => {
//   const scrollToTop = () => {
//     window.scrollTo({
//       top: 0,
//       behavior: "smooth"
...
//   return (
//     <Link to={to} className={className} style={style} onClick={scrollToTop} {...props}>
//       {children}
//     </Link>
//   );
// };
...
//         {/* ══════════════════════════════════════════
//             ROW 1 — NEWSLETTER + GIFT CARDS (Absolute Center Lock)
//             ══════════════════════════════════════════ */}
//         <div className="w-full px-8 md:px-16 py-14 flex justify-center">
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 w-fit">
...
//                 Stay up to date
//               </h3>
//               <p className="text-[14px] text-[#2a2a2a] mb-6 leading-relaxed">
//                 Receive exclusive offers, find inspiration and discover new arrivals.
//               </p>

//               <form
//                 className="flex items-center w-full bg-white rounded-full overflow-hidden mb-8 shadow-sm"
...
//               <ScrollLink
//                 to="/gift-cards"
//                 className="flex items-center justify-center gap-3 bg-black text-white text-[13px] font-black uppercase tracking-widest px-8 py-4 rounded-full hover:bg-[#222] transition-colors w-full"
//                 style={{ fontFamily: "Montserrat, sans-serif" }}
//               >
...
//           <div>
//             <h4 className="text-[15px] font-semibold text-black mb-5" style={{ fontFamily: "Montserrat, sans-serif" }}>Store</h4>
//             <div className="flex flex-col gap-3 text-[14px] text-[#2a2a2a]">
//               <ScrollLink to="/shop" className="hover:text-black hover:underline transition-all w-fit">All Products</ScrollLink>
//               <ScrollLink to="/bestsellers" className="hover:text-black hover:underline transition-all w-fit">Bestsellers</ScrollLink>
//               <ScrollLink to="/new-arrivals" className="hover:text-black hover:underline transition-all w-fit">New Arrivals</ScrollLink>
//               <ScrollLink to="/shop" className="hover:text-black hover:underline transition-all w-fit">Shop by Mood</ScrollLink>
//               <ScrollLink to="/gift-ideas" className="hover:text-black hover:underline transition-all w-fit">Gift Ideas</ScrollLink>
//             </div>
//           </div>

//           <div>
//             <h4 className="text-[15px] font-semibold text-black mb-5" style={{ fontFamily: "Montserrat, sans-serif" }}>Policies</h4>
//             <div className="flex flex-col gap-3 text-[14px] text-[#2a2a2a]">
//               <ScrollLink to="/shipping-policy" className="hover:text-black hover:underline transition-all w-fit">Shipping Policy</ScrollLink>
//               <ScrollLink to="/cancellation-refund" className="hover:text-black hover:underline transition-all w-fit">Cancellation & Refund</ScrollLink>
//               <ScrollLink to="/terms" className="hover:text-black hover:underline transition-all w-fit">Terms & Conditions</ScrollLink>
//               <ScrollLink to="/privacy" className="hover:text-black hover:underline transition-all w-fit">Privacy Policy</ScrollLink>
//               <ScrollLink to="/disclaimer" className="hover:text-black hover:underline transition-all w-fit">Website Disclaimer</ScrollLink>
//               <ScrollLink to="/#faqs" className="hover:text-black hover:underline transition-all w-fit">FAQ</ScrollLink>
//             </div>
//           </div>

//           <div>
//             <h4 className="text-[15px] font-semibold text-black mb-5" style={{ fontFamily: "Montserrat, sans-serif" }}>Support</h4>
//             <div className="flex flex-col gap-3 text-[14px] text-[#2a2a2a]">
//               <ScrollLink to="/track-order" className="hover:text-black hover:underline transition-all w-fit font-semibold">Track Your Order</ScrollLink>
//               <ScrollLink to="/contact" className="hover:text-black hover:underline transition-all w-fit">Contact Page</ScrollLink>
//               <a href="mailto:helpmuroposter@gmail.com" className="flex items-center gap-2 hover:text-black hover:underline transition-all w-fit"><Mail size={15} /> helpmuroposter@gmail.com</a>
//               <a href="https://wa.me/918059700876" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-black hover:underline transition-all w-fit"><Phone size={15} /> +91 80597 00876</a>
//               <div className="flex items-start gap-2 text-[#2a2a2a]">
//                 <Clock size={15} className="mt-0.5 flex-shrink-0" />
//                 <span>Mon – Fri<br />10:00 AM – 6:00 PM (IST)</span>
//               </div>
//             </div>
//           </div>

//           <div>
//             <h4 className="text-[15px] font-semibold text-black mb-5" style={{ fontFamily: "Montserrat, sans-serif" }}>About Muro</h4>
//             <div className="flex flex-col gap-3 text-[14px] text-[#2a2a2a]">
//               <ScrollLink to="/about" className="hover:text-black hover:underline transition-all w-fit">About Us</ScrollLink>
...
//           {["Secure Payment Processing", "Efficient Order Handling", "Customer Support Available"].map((item, index, arr) => (
//             <div key={item} className="flex items-center gap-6">
//               <span className="text-[12px] uppercase tracking-widest text-[#2a2a2a]">{item}</span>
//               {index < arr.length - 1 && <span className="text-[#2a2a2a]/40 text-[12px]">|</span>}
//             </div>
//           ))}
//         </div>
...
//                 return (
//                   <line key={i} x1={10 + 0.3 * Math.cos(angle)} y1={7 + 0.3 * Math.sin(angle)} x2={10 + 1.8 * Math.cos(angle)} y2={7 + 1.8 * Math.sin(angle)} stroke="#000080" strokeWidth="0.25" />
//                 );
//               })}
//             </svg>
...
//             </div>
//             <div className="bg-white rounded-md px-2 py-1.5 flex items-center justify-center h-9 w-14 shadow-sm">
//               <span className="text-[11px] font-black tracking-tight"><span className="text-[#4285F4]">G</span><span className="text-[#EA4335]">o</span><span className="text-[#FBBC05]">o</span><span className="text-[#34A853]">g</span><span className="text-[#4285F4]">le</span></span>
//             </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm opacity-70">
              ...
              <Link to="/#faqs" className="hover:opacity-100 hover:text-white transition-all w-fit">FAQ</Link>
