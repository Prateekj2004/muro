    ...
    <PolicyPage title="Shipping Policy">
      ...
      */}
      <section className="space-y-8">
        ...
        {/* Shipping & Delivery */}
        <div className="space-y-4 border-t border-[#1c1c1c]/10">
          <h1 className="text-2xl font-bold pt-4 text-[#1c1c1c]" style={{ WebkitTextStroke: "0.5px #1c1c1c" }}>Shipping & Delivery</h1>
        ...
        {/* Packaging */}
        <div className="space-y-4 border-t border-[#1c1c1c]/10">
          <h1 className="text-2xl font-bold pt-4 text-[#1c1c1c]" style={{ WebkitTextStroke: "0.5px #1c1c1c" }}>Packaging</h1>
        ...
        {/* Tracking */}
        <div className="space-y-4 border-t border-[#1c1c1c]/10">
          <h1 className="text-2xl font-bold pt-4 text-[#1c1c1c]" style={{ WebkitTextStroke: "0.5px #1c1c1c" }}>Tracking</h1>
          <p>A tracking link will be sent via email once your order has been shipped.</p>
        </div>

        {/* Shipping Issues */}
        <div className="space-y-4 border-t border-[#1c1c1c]/10">
          <h1 className="text-2xl font-bold pt-4 text-[#1c1c1c]" style={{ WebkitTextStroke: "0.5px #1c1c1c" }}>Shipping Issues</h1>
        ...
        {/* Force Majeure */}
        <div className="space-y-4 border-t border-[#1c1c1c]/10 ">
          <h1 className="text-2xl font-bold pt-4 text-[#1c1c1c]" style={{ WebkitTextStroke: "0.5px #1c1c1c" }}>Force Majeure</h1>
        ...
        {/* Footer Quote */}
        <div className="mt-12 font-bold pt-8 border-t border-[#1c1c1c]/10">
          <p className=" opacity-60" >We don’t ship decorations. We ship intention.</p>
          <p className=" opacity-60" >Choose what surrounds you carefully — we’ll handle the rest.</p>
        </div>
